export default class Tools {
    ...
    static pointOnSegment(point, segment) {
        point = Tools.roundPoint(point, 1e6);
        segment[0] = Tools.roundPoint(segment[0], 1e6);
        segment[1] = Tools.roundPoint(segment[1], 1e6);
        return (
    ...
    static getVectorSegmentIntersection(point1, vector1, segment) {
        var
            point2 = segment[0],
        ...
        if (vector1[0] === 0) {
            ...
            if (Tools.pointOnSegment(xy, segment)) {
                return xy;
            }
        }
        if (vector2[0] === 0) {
...
// }
    ...
    static getDistanceToLine(point, line) {
        var
            r1 = line[0],
            r2 = line[1];
