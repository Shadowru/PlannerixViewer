import Qolor from 'qolor';
import Roofs from "./roofs/Roofs";
import Split from "./Split";

export default class Triangulate {
    ...
    static triangulate() {
        ...
        function triangulate(buffers, feature, origin, forcedColor, colorVariance) {
            ...
            alignGeometry(feature.geometry).map(geometry => {
                ...
                addBuilding(buffers, feature.properties, polygon, forcedColor, colorVariance, new Roofs());
            });
        }
        ...
        function varyColor(col, variance) {
            ...
            return [rgb[0] + variance, rgb[1] + variance, rgb[2] + variance, 0xFF];
        }

        //***************************************************************************

        // TODO: add floor polygons if items have minHeight
        function addBuilding(buffers, properties, polygon, forcedColor, colorVariance, roofs) {
            const
            ...
            roofs.createRoof(buffers, properties, polygon, dim, roofColor, wallColor);
